...
class extends Component {
    ...
    public function articles(): Collection
    {
        ...
        // Add click_count as a subquery for momentum display
        $query->addSelect([
            'click_count' => DB::table('article_clicks')
                ->selectRaw('COUNT(*)')
                ->whereColumn('article_clicks.article_id', 'articles.id')
                ->where('article_clicks.clicked_at', '>=', now()->subDay()),
        ]);
