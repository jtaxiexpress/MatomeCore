...
return new class extends Migration
{
    ...
    public function down(): void
    {
        Schema::table('articles', function (Blueprint $table) {
            $columns = [];
            if (Schema::hasColumn('articles', 'url_hash')) $columns[] = 'url_hash';
            if (Schema::hasColumn('articles', 'status')) $columns[] = 'status';
            if (Schema::hasColumn('articles', 'summary')) $columns[] = 'summary';
            if (Schema::hasColumn('articles', 'lead_text')) $columns[] = 'lead_text';
